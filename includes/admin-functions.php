...
function cac_cc_register_scripts() {
	...
	wp_localize_script( 'cac-creative-commons', 'CAC_Creative_Commons', array( 
		...
		'questions' => array(
			...
			'publicDomainDesc' => esc_html__( 'If you want to share a work you created with no conditions, select Yes. If you want to share your work, but with some restrictions, select No.', 'cac-creative-commons' ),
